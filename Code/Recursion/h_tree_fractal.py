# Thuật toán tạo ra cây dạng chữ H theo cách đệ quy
...
def draw_line(tur, pos1, pos2):
    # print("Drawing from", pos1, "to", pos2)  #Xóa comment để theo dõi thuật toán
    tur.penup()
    tur.goto(pos1[0], pos1[1])
    tur.pendown()
    tur.goto(pos2[0], pos2[1])  # Đây chính là tọa độ 2d
